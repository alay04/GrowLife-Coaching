	...
	return (
		<div className="bg-amber-50 min-h-[60vh] p-6 lg:p-16 text-gray-900">
			...
			<div className="flex flex-col my-8 lg:flex-row justify-center items-center gap-8">
				...
				<img src="/3-session/002.jpeg" className="mx-auto lg:w-[50%]" alt="" />
			</div>
			<p className="lg:text-justify text-xl lg:text-2xl mb-4">
				The 3 Session Coaching Plan is designed for focused, impactful change in
				a shorter timeframe. It’s ideal if you’re looking for clarity,
				direction, and tangible results without a long-term commitment.
			</p>
			<div className="my-4 flex flex-col gap-4">
				...
				<p className="text-xl lg:text-2xl">
					Your journey begins with a Suitability Session, where we explore your
					current situation, define your goals, and ensure the coaching
					relationship feels aligned and supportive. This session creates a
					clear foundation, allowing us to work efficiently and intentionally
					from the very start.
				</p>
				<p className="text-xl lg:text-2xl">
					You’ll then move through three tailored coaching sessions, each
					carefully designed to build momentum and drive results. Together, we
					shall increase your self-awareness, identify key obstacles or limiting
					patterns, and develop practical strategies to move you forward. These
					sessions focus on clarity, action, and confidence, helping you make
					decisive shifts where they matter most.
				</p>
				<p className="text-xl lg:text-2xl">
					This plan is ideal if you’re seeking quick but meaningful
					breakthroughs, structured guidance, and accountability over a
					concentrated period. By the end of the three sessions, you can expect
					to have clear goals, actionable steps, and tools you can immediately
					apply to your daily life. You will feel more focused, empowered, and
					equipped to move forward with confidence, not just with insight, but
					with real, visible progress.
				</p>
				<p className="text-xl lg:text-2xl">
					If you’re ready to take purposeful action and create results without
					overwhelm, the 3 Session Coaching Plan offers a powerful starting
					point for lasting change.
				</p>
			</div>
			<div className="my-4 flex flex-col gap-4">
				...
				<ul className="list-disc text-xl lg:text-2xl px-2">
					...
					<li>
						You will be able to use practical tools and strategies to overcome
						barriers and take purposeful actions.
					</li>
					<li>
