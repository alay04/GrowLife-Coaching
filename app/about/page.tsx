		...
		<div className="overflow-x-hidden bg-amber-50 min-h-[60vh] text-gray-900 p-8">
			...
			<div className="flex flex-col gap-16 text-left lg:text-justify">
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
					<div className="col-span-1 lg:col-span-2 text-2xl">
						<p>
							I’m a life coach who empowers. My work is focused on synergy. Not
							from textbooks, but from genuine connection, willingness and
							understanding. I firmly believe you get out what you put in. I
							tailor each session with that in mind so that you feel energised
							and focused.
						</p>
					</div>
					<div className="col-span-1 shadow-md flex flex-col justify-center items-center">
