	...
	return (
		<div className="bg-amber-50 min-h-[60vh] p-6 lg:p-16 text-gray-900">
			...
			<div className="flex flex-col my-8 lg:flex-row justify-center items-center gap-8">
				<img src="/6-session/001.jpeg" className="mx-auto lg:w-[50%]" alt="" />
			...
			<div className="my-4 flex flex-col gap-4">
				...
				<ul className="list-disc text-xl lg:text-2xl px-2">
					...
					<li>Develop skills, strategies and build momentum and confidence</li>
					<li>
						Consolidate learning and establish and support sustainable change
					</li>
				</ul>
				<p className="text-xl lg:text-2xl">
					Your journey begins with a Suitability Session, a dedicated space for
					clarity and connection. During this session, we explore your goals,
					challenges, and aspirations, ensuring the coaching relationship feels
					aligned, supportive, and right for you. This foundation allows us to
					work together with intention, trust, and focus from the very start.
				</p>
				<p className="text-xl lg:text-2xl">
					Following this, you’ll move through six deeply personalised coaching
					sessions, tailored specifically to you. Each session builds upon the
					last, helping you develop greater self-awareness, uncover limiting
					patterns, and replace them with empowering beliefs and habits. With
					consistent guidance and structured support, you’ll gain the confidence
					to take aligned action and create momentum that carries forward beyond
					our time together.
				</p>
				<p className="text-xl lg:text-2xl">
					This plan is ideal if you’re seeking deeper breakthroughs, consistent
				...
				<p className="text-xl lg:text-2xl">
					...
					certainty around your goals, practical tools to navigate challenges,
					and a stronger sense of direction and confidence in your
					decision-making.
				</p>
				<p className="text-xl lg:text-2xl">
					You’ll leave with actionable strategies, sustainable habits, and
					renewed momentum, not just insight, but real change you can see and
			...
			<div className="my-4 flex flex-col gap-4">
				...
				<ul className="list-disc text-xl lg:text-2xl px-2">
					...
					<li>
						You can expect to apply effective strategies and tools to overcome
						obstacles, make informed decisions, and take consistent action
						toward your goals.
					</li>
					<li>
			...
			<div className="flex flex-col justify-center mt-8 items-center gap-4">
				...
				<a
					href="https://cal.com/officer-nasty-d9p4ge/6-session-coaching-plan"
					target="_blank"
