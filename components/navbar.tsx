    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          ...
          <li>
            <a
              href={meetingLinks["booking-calender"]}
              target="_blank"
              className="bg-green-600 text-lg lg:text-sm cursor-pointer hover:bg-green-700 active:bg-green-800 text-white py-4 px-8 rounded-full hover:shadow-lg shadow-green-300 active:translate-y-1 duration-300 transition-all hover:-translate-y-px w-fit uppercase font-bold"
            >
              Book Now
            </a>
          </li>
