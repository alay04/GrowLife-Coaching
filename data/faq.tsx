	...
	},
	{
		...
		answer: (
			<p className="text-lg ">
				...
				coaching can be incredibly powerful.
			</p>
		),
	},
	{
		...
		answer: (
			<div className="text-lg ">
				...
				<ul className="list-disc text-xl pl-8">
					...
					<li>Discuss how coaching can support you</li>
					<li>Answer any questions you may have</li>
					<li>Decide whether we are the right fit</li>
				</ul>
				<p>There is no pressure or commitment, just space to talk.</p>
			</div>
		),
	},
	{
		...
		answer: (
			<div className="text-lg ">
				...
				<ul className="list-disc text-sm lg:text-xl pl-8">
					...
					<li>Via telephone and face time.</li>
					<li>Answer any questions you may have</li>
					<li>
						In person sessions may be available depending on your location, ask
						for further details.
					</li>
				</ul>
			</div>
	...
	},
	{
		...
		answer: (
			<div className="text-lg ">
				...
				<ul className="list-disc text-xl pl-8">
					<li>1:1 coaching sessions in addition to the suitability session</li>
					<li>A personalised roadmap</li>
					<li>Tools, exercises and reflections</li>
					<li>Progress tracking</li>
					<li>Email or message support between sessions</li>
				</ul>
			</div>
		),
	},
	{
		...
		answer: (
			<div className="text-lg ">
				...
				<p>It’s designed to create long-term, sustainable growth.</p>
			</div>
		),
	},
	{
	...
	},
	{
		...
		answer: (
			<p className="text-lg ">
				...
				for teams, workplaces, or groups wanting to grow together.
			</p>
		),
	},
	{
		...
		answer: (
			<div className="text-lg ">
				...
				<p>
					All tailored to your audience or organisation. Popular topics include
					mindset, motivation, communication, wellbeing, resilience, equality
		...
		answer: (
			<div className="text-lg ">
				...
				<ul className="list-disc text-xl pl-8">
					...
					<li>A 1:1 debrief</li>
					<li>
						Clear guidance on how to apply your strengths in everyday life or
						work
					</li>
				</ul>
			</div>
		...
		answer: (
			<div className="text-lg ">
				<p>
					...
					tools, complete exercises, and stay consistent between sessions.
				</p>
			</div>
		),
	},
		...
		answer: (
			<div className="text-lg ">
				<p>
					...
					the option that best supports you.
				</p>
			</div>
		),
	},
		...
		answer: (
			<div className="text-lg ">
				<p>
					...
					experiences.
					<br />
					Coaching focuses on goals, growth, and the future. Both are valuable,
					just different.
				</p>
			</div>
		),
		...
		answer: (
			<div className="text-lg ">
				<p>
					...
					any payment method offered at checkout.
					<br />
					For cancellations, we kindly ask for at least 48 hours’ notice.
					Cancellations made within this window can be rescheduled at no charge.
					Sessions cancelled late or missed without notice may be charged in
					full, as that time is reserved for you.
				</p>
			</div>
		),
	},
